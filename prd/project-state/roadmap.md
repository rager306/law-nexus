...
- **Local GSD workflow marker:** M168-vbbcxj is the latest completed milestone in GSD registry (Consultant parser remediation wave: honest evidence ceilings, tracked end-to-end contract, scored classifier composition, bounded morph signals, read-only SQLite CatalogPort adapter). Product/design current-front remains evidence-gated; GSD completion is not product readiness.
