...
- **Local GSD workflow marker:** M167-odlgt8 is the latest completed milestone in GSD registry (NormRule IR design spine; skip-waiver catch-up after out-of-band F04a evidence). Product/design current-front remains evidence-gated; GSD completion is not product readiness.
