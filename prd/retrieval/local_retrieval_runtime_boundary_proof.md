...
- `prd/milestone_proofs/M001_S10_EMBEDDING-RUNTIME-PROOF.json` — bounded prior source evidence for the approved model and `1024` observed dimension, cited only as repository-relative provenance.
