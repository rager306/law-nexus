...
| RQ-008 | Keep O1–O7 temporal ontology as explicit proof-gated design | PC-008 | `active` / `[proposed]` | none-design | ADR-0016, ADR-0017, ADR-0018, ADR-0019, ADR-0020, ADR-0021, ADR-0022 | ADR design review; future layer-specific TDD + hostile cases | no implemented ontology runtime or R035 validation |
