...
| KBO-R046 | gap | `resolve_CTV(cc, t)` is the main capability gap vs de Martim v5; text CTV canon (ADR-0017 §1c) is design-only; bounded prototype on one component is the next step | Review 5 R5-02; TSG-003; ADR-0017 §1c | **open** |
