...
| KBO-R045 | core-contract | `edition_ast_at(t)` unifies three L2 canons: CompositionAst = fold(membership ≤ t); EditionAst = filter(CompositionAst, fold_presence ≤ t); TextAst = resolve_CTV(cc, t) [not shipped]. Closes S_fold exit criterion | Review 5 R5-03; ADR-0017 §1a | **accepted-draft** |
