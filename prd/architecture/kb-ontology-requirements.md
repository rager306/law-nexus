...
| KBO-R049 | core-contract | Cross-act edges S0→S1 transition requires: typed `CrossActEdgePort` + hostile tests (delegation underdetermined→Conflict, circular amends→rejected) + at least one real C1 edge | Review 5 R5-06; ADR-0019; TSG-007 | **accepted-draft** (port + hostile tests done; real C1 edge pending) |
