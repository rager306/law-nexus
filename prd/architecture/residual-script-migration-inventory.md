...
| 17 | `scripts/build-parser-golden-cases.py` | 831 | 17 | 0 | yes | migrate logic | high | M078 S04 extracted shared helpers; M079 S02 moved build-case core to `law_nexus.adapters.sources.parser_golden_cases`; report/render/write CLI wrapper remains script-owned |
...
| 31 | `scripts/evaluate-parser-golden-cases.py` | 826 | 21 | 0 | yes | migrate logic | high | M078 S04 extracted shared helpers; M079 S03 moved evaluator core to `law_nexus.adapters.sources.parser_golden_cases`; CLI wrapper remains script-owned |
