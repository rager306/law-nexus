...
| `model-crystal-anchors` | Verify the Reviews 10–14 model crystal projection grounding: declared source sha256 digest, verbatim `anchor:` quotes against the immutable L0 review-25 file, required Layer 0/1 sections and INV-01..08, 09a/09b/09c, 10, 11 definition rows (13 rows; no bare 09) | advisory `warn`; grounding drift only, never meaning or canon |
