...
| `model-crystal-anchors` | Verify the Reviews 10–14 model crystal projection grounding: declared source sha256 digest, verbatim `anchor:` quotes against the immutable L0 review-25 file, required Layer 0/1 sections and INV-01..10 definition rows | advisory `warn`; grounding drift only, never meaning or canon |
