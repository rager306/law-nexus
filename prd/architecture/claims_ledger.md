...
| --- | --- | --- | --- | --- | --- |
| `ACP-PG-0001` | Minimal ACP fixture validation gate | architecture-governance | registry/process | medium | ❌ Does not validate R035.; ❌ Does not validate R037. |
...
| --- | --- | --- | --- | --- | --- | --- |
| `ACP-APR-0001` | Capture ACP minimal fixture validation intent | architecture-governance | registry/process | medium | source-anchor | ❌ Does not validate R035.; ❌ Does not validate R037.; ❌ Does not validate R038.; ❌ Does not prove parser completeness.; ❌ Does not prove legal correctness.; ❌ Does not prove FalkorDB ingestion or runtime loading.; ❌ Does not prove graph-vector retrieval quality.; ❌ Does not prove production readiness.; ❌ Does not prove independent external review.; ❌ Prompt provenance is not implementation proof. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ACP-AHF-0001` | ACP runtime adoption is blocked until fixture validation exists | architecture-governance | registry/process | high | blocked | static-check | Generated by scripts/extract-prd-architecture-items.py and c... | ❌ Does not validate R035.; ❌ Does not validate R037. |
...
| --- | --- | --- | --- | --- | --- | --- |
| `ACP-AP-0001` | Validate ACP minimal fixture chain before broader tooling | architecture-governance | registry/process | medium | proposed | ❌ Does not validate R035.; ❌ Does not validate R037. |
| `ACP-DC-0001` | Require fixture validation before ACP runtime adoption | architecture-governance | registry/process | medium | proposed | ❌ Does not validate R035.; ❌ Does not validate R037. |
