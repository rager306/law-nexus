...
| `GATE-G008` | Product parser and retrieval readiness gate | parser-ingestion | bounded-technical-proof | high | none | Future product proof demonstrates parser completeness bounda... | ❌ No parser completeness claim.; ❌ No product retrieval quality claim. |
