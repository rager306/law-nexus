...
| TSG-015 | Golden-case catalog breadth and executable promotion | evidence | temporal model TL-G01..TL-G12 | 19 TL-GC paper oracles in temporal-legal-model §11 plus 40 GC catalog rows (design-only, M183); mixed ceilings; TL-G01..12 remain the older paper-set label | paper cases and catalog rows are semantic-shape oracles, not legal gold and not executed fixtures | each promoted case has an owner, executable positive/hostile proof, revision-bound fixture and honest non-claim | active |
