...
| `EffectSelector` | At / AfterPublication / OnEvent / OnCondition / ForRelationsAfter / RetroactiveTo / Unknown — a projection of five-clock roles carried by a LegislativeEffect | ADR-0017 G0(c) + ADR-0009 G0 note (D216) | canonical design term `[proposed]` | not a sixth clock; `Unknown` never silently orders; non-commuting effects yield `OrderingConflict` |
