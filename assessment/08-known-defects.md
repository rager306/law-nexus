...
| DOC-04 | `prd/project-state/roadmap.md` сообщает устаревший M160/M161 front | P0 | D5 / EA-05 | addressed-in-draft | project-state Markdown/JSON updated to M165 + D5/D6/EA-05; historical roadmap banners/lifecycles corrected; closure requires frozen front scan + disposition |
...
| DOC-06 | Temporal readiness покрыт в основном `GATE-G005`, без полного набора CTV/applicability/correction/case gates | P1 | D6 / EA-05 | addressed-in-draft | single matrix `prd/temporal-legal-model.md` §10–10.1 now includes TL-G01–12, graduation/evidence/dependencies + hostile/golden cases; closure requires frozen review + disposition |
...
- `addressed-in-draft` для DOC-01/DOC-02/DOC-06/DOC-07/DOC-08/DOC-09/DOC-10 означает только working-tree correction или наличие paper design/baseline artifacts, не выполнение owning phase exit и не closure.
