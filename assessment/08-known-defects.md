...
| DOC-07 | Cross-surface matrix не моделирует Product Contract и external assessment authority | P1 | D2 + D6 / EA-02 + EA-05 | verified-closed | frozen closure PASS at `23eb715`: 11 consequential PC→RQ→ADR chains plus assessment process-only boundary; later structural expansion covers PC/RQ-001..020 and does not reopen DOC-07; hostile broken-link fixture passes; publication structure only, not semantic correctness or requirement/product proof |
