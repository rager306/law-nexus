...
| DOC-06 | Temporal readiness покрыт в основном `GATE-G005`, без полного набора CTV/applicability/correction/case gates | P1 | D6 / EA-05 | addressed-in-draft | `prd/temporal-legal-model.md` defines TL-G01–12 + hostile/golden cases; closure still requires D6 matrix integration, frozen review and disposition |
