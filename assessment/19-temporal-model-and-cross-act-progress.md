...
| C1 amends | 138-ФЗ → 44-ФЗ ст. 31/43; 333-ФЗ → ст. 95 | `real_cross_act_edges.rs`; KBO-R049 **S1** | **484-ФЗ acquired, edge not executed.** Нет 118-edition verify | Исполнить 484 *после* honesty-волны, не называть 3 ребра корпусом. R070 provenance → edition delta открыт |
...
| P-04 | 484-ФЗ «acquired; edge not executed» не в DESIGN FRONT leftover | Следующий агент начнёт G1 и забудет C1-хвост | Честный leftover на living surfaces без раздувания ARCHITECTURE за 325 строк |
