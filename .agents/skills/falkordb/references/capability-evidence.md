...
- A 2026-05-10 local run against `falkordb/falkordb:edge` image `sha256:4246e809a5fd74d233196e08c879885adc47bde499a8e25fa5ff83fd39644d80` confirmed synthetic Docker FalkorDB basic graph, UDF load/execute, procedure list, full-text index, vector index, vector-distance, PageRank, WCC, BFS, betweenness, label propagation, SPpaths, and SSpaths output-shape probes, plus FalkorDBLite basic/UDF/vector/full-text probes. This confirms only the bounded synthetic runtime behavior, not LegalGraph ETL/import/product retrieval quality or production algorithm suitability.
