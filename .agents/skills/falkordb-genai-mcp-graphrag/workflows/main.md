# Workflow: Design or Evaluate FalkorDB GenAI/MCP/GraphRAG
...
Identify FalkorDB version, runtime mode, relevant docs surface, data shape, and whether the task is design, implementation, verification, or debugging.
...
Use the reference guidance for this skill. Keep examples small, parameterized, version-aware, and runnable where possible.

## Step 4 — Verify
Provide a command, query, fixture, API request, or review checklist that proves the answer. If verification cannot be run, state the blocker and next proof.
</process>
